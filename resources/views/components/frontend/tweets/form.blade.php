<section class="tweet_form">
    ...
    <form method="POST" action="{{ route('frontend.tweet.create') }}" enctype="multipart/form-data">
        @csrf
        <textarea name="content" placeholder="your text here" class="uk-textarea" rows="4"></textarea>
        <button class="uk-button uk-button-primary uk-margin uk-width-1-1">Send Tweetく</button>
